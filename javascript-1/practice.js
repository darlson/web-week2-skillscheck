...
let bigOrSmall = arr => {
	let answers = []
	arr.forEach(e => (e > 100) ? answers.push('big') : answers.push('small'))
	return answers
}
...
let enemies = people.filter( e => (!e.friend)  )
...
let totallyAwesome = people.reduce( (acc, e) => acc + e.awesomeLevel, 0 )

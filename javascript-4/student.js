...
const faveColors = ['limegreen', 'darkgrey', 'blue', 'cerulean', 'chartreuse', 'charcoal']
...
const me = {
    firstName: 'David',
    superHeroName: 'The Timeless Man',
    homeTown: 'The City of Townsville',
    superPowers: ['spacetime manipulation', 'flight', 'invisibility'],
